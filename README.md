...
[![GoDoc](https://godoc.org/go.linka.cloud/libkv?status.png)](https://godoc.org/go.linka.cloud/libkv)
...
[![Go Report Card](https://goreportcard.com/badge/go.linka.cloud/libkv)](https://goreportcard.com/report/go.linka.cloud/libkv)

**Forked from [docker/libkv](https://go.linka.cloud/libkv)**
